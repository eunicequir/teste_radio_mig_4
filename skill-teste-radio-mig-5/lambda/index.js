...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Bemvindo, você pode dizer "tocar radio" para ouvir a radio. O que gostaria que eu fizesse?';
...
const PlayAudioIntentHandler = {
    ...
    async handle(handlerInput) {
        ...
        const speakOutput = 'Tocando o audio stream.';
        const playBehavior = 'REPLACE_ALL';
        const podcastUrl = 'https://radio02.zas.media/proxy/aleluia/stream';
...
const UnsupportedAudioIntentHandler = {
    ...
    async handle(handlerInput) {
        const speakOutput = 'Desculpa, Eu não posso suportar isso por enquanto.';
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Você pode dizer "tocar rádio" para iniciar! Como eu posso te ajudar?';
